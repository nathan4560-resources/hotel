...
public class DoubleRoomActivity extends AppCompatActivity {
    ...
    private static final String ROOM_ID = "102";  // Setting the room ID to 102 for Double Room
    ...
    private void saveBookingToFirebase() {
        ...
        // Create a BookingDetails object with the room ID set to 102
        ...
        databaseReference.child(email.replace(".", "_")).child(ROOM_ID).setValue(bookingDetails)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(DoubleRoomActivity.this, "Booking saved successfully", Toast.LENGTH_SHORT).show();
                    } else {
                        // Handle failure
                        Toast.makeText(DoubleRoomActivity.this, "Failed to save booking", Toast.LENGTH_SHORT).show();
                    }
                });
    }
