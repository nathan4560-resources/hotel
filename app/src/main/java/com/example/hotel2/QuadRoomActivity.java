...
public class QuadRoomActivity extends AppCompatActivity {
    ...
    private static final String ROOM_ID = "104";  // Setting the room ID to 104 for Quad Room

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quad_room);
    ...
    private void saveBookingToFirebase() {
        ...
        // Create a BookingDetails object with the room ID set to 104
        ...
        databaseReference.child(email.replace(".", "_")).child(ROOM_ID).setValue(bookingDetails)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(QuadRoomActivity.this, "Booking saved successfully", Toast.LENGTH_SHORT).show();
                    } else {
                        // Handle failure
                        Toast.makeText(QuadRoomActivity.this, "Failed to save booking", Toast.LENGTH_SHORT).show();
                    }
                });
    }
