...
public class SingleRoomActivity extends AppCompatActivity {
    ...
    private static final String ROOM_ID = "101";  // Setting the room ID to 101
    ...
    private void saveBookingToFirebase() {
        ...
        // Create a BookingDetails object with the room ID set to 101
        ...
        databaseReference.child(email.replace(".", "_")).child(ROOM_ID).setValue(bookingDetails)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(SingleRoomActivity.this, "Booking saved successfully", Toast.LENGTH_SHORT).show();
                    } else {
                        // Handle failure
                        Toast.makeText(SingleRoomActivity.this, "Failed to save booking", Toast.LENGTH_SHORT).show();
                    }
                });
    }
